        ...
        <div>
            <main className="flex flex-col gap-y-20">
                ...
                <section className="flex justify-center flex-col items-center gap-5">
                    <CardProfissional background={"#FFF1B4"} conteudo="Monitora do evento II Semana de Sistemas para Internet - UNICAP 2024" />
                    <CardProfissional background={"#FFE4CC"} conteudo="Monitora do projeto de extensão GREA3D Móvel - UFPE 2024-2025 " />
                </section>
            </main>
        </div>
    )
