        ...
        <header>
            <nav>
                <ul className="text-lg font-bold text-white flex gap-x-7 justify-end px-12 py-6 border-b-4 border-pink-300">
                    ...
                    <li><Link href="/formacao" className="w-24 bg-pink-300 text-white duration-200 ease-in-out hover:text-pink-300 hover:bg-white border-1 border-pink-300 rounded-sm p-2">Formações</Link></li>
